...
后续开发计划：注重理解和写作，过程中可以写一部分小的代码辅助理解，最重要的是理解，核心在于理解而非产出代码。过去经验说明，追求速度、堆砌代码，往往导致后续反复调试，最终仍需回头补足理解，这不仅是巨大的时间浪费，更剥夺了学习的反馈感，就好像把人沦为了ai的调试工具。之后用qemu-monitor看一下vmcb和寄存器的值，多和老师交流下。
